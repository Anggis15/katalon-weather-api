...
<WebServiceRequestEntity>
   ...
   <name>Historical Air Pollution</name>
   <tag></tag>
   <elementGuidId>417e6244-1757-4721-b765-6e84b5530713</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/air_pollution/forecast?lat=${lat}&amp;lon=${lon}&amp;start=1734636629&amp;end=1735068629&amp;appid=${appId}</restUrl>
