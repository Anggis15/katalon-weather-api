...
<WebServiceRequestEntity>
   ...
   <name>Forecast Air Pollution</name>
   <tag></tag>
   <elementGuidId>391c855d-918a-402e-9c2b-264e1456181f</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/air_pollution/forecast?lat=${lat}&amp;lon=${lon}&amp;appid=${appId}</restUrl>
