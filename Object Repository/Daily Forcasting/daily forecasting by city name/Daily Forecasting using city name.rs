...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using city name</name>
   <tag></tag>
   <elementGuidId>e355a847-acfb-4592-8895-8d7150562854</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&amp;appid=${appId}</restUrl>
