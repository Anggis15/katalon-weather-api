...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>6edb032f-179c-44c1-bae5-3a6733f6ad60</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&amp;mode=xml&amp;unit=imperial&amp;cnt=${cnt}&amp;lang=KR&amp;appid=${appId}</restUrl>
