...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using city name and lang</name>
   <tag></tag>
   <elementGuidId>6d9edb8c-7460-48f2-ab46-762c744ee8a2</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&amp;lang=id&amp;appid=${appId}</restUrl>
