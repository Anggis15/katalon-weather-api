...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, countryCode, and cnt less than 5 days</name>
   <tag></tag>
   <elementGuidId>3bb27720-f454-43f6-97f3-36fab66cbdaf</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${countryId}&amp;cnt=${cnt}&amp;appid=${appId}</restUrl>
