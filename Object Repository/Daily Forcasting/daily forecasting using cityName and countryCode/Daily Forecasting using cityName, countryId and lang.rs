...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, countryId and lang</name>
   <tag></tag>
   <elementGuidId>7959a684-7a3e-48f0-a5cd-ff58baa33b0d</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${countryId}&amp;lang=KR&amp;appid=${appId}</restUrl>
