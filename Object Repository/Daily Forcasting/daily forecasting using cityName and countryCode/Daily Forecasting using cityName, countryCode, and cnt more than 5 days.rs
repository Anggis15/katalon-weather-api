...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, countryCode, and cnt more than 5 days</name>
   <tag></tag>
   <elementGuidId>6db066b2-3d92-4325-a03c-3869bb6ad071</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${countryId}&amp;cnt=45&amp;appid=${appId}</restUrl>
