...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, countryCode and units metric</name>
   <tag></tag>
   <elementGuidId>75a6a9a9-996c-40f8-8f22-ce965b86ee15</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${countryId}&amp;units=metric&amp;appid=${appId}</restUrl>
