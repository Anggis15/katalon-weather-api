...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, countryCode and units imperial</name>
   <tag></tag>
   <elementGuidId>8f7c45ad-13a8-4e60-a5f0-efebc78b509c</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${countryId}&amp;units=imperial&amp;appid=${appId}</restUrl>
