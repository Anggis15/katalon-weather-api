...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using latitude, longitude and cnt more than 5 days</name>
   <tag></tag>
   <elementGuidId>3bf0d00a-748f-4066-9ec6-3a590977eddf</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&amp;lon=${longitude}&amp;cnt=45&amp;appid=${appId}</restUrl>
