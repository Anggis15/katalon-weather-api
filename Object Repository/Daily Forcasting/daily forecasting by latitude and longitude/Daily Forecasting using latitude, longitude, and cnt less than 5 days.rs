...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using latitude, longitude, and cnt less than 5 days</name>
   <tag></tag>
   <elementGuidId>88777bbd-80cd-49e7-a835-0cb8fd8750bf</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&amp;cnt=${cnt}&amp;appid=${appId}</restUrl>
