...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using latitude, longitude and units imperial</name>
   <tag></tag>
   <elementGuidId>eb46dbd6-7998-408f-abe9-448ccc19ec89</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&amp;lon=${longitude}}&amp;units=imperial&amp;appid=${appId}</restUrl>
