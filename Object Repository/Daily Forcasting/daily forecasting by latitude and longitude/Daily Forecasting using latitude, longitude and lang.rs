...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using latitude, longitude and lang</name>
   <tag></tag>
   <elementGuidId>ad460f62-51ff-4d1d-870a-16c9b1ffd67c</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&amp;lon=${longitude}&amp;lang=id&amp;appid=${appId}</restUrl>
