...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using latitude, longitude and units metric</name>
   <tag></tag>
   <elementGuidId>79cce76b-d01b-4468-be2a-03d0cfae7558</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&amp;lon=${longitude}&amp;units=metric&amp;appid=${appId}</restUrl>
