...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using latitude, longitude and mode is XML</name>
   <tag></tag>
   <elementGuidId>a80a256d-5cbd-47aa-9168-cdac19e046f0</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&amp;lon=${longitude}&amp;mode=xml&amp;appid=${appId}</restUrl>
