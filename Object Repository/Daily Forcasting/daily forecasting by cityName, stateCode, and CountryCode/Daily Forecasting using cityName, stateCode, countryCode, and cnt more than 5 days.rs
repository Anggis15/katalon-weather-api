...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, stateCode, countryCode, and cnt more than 5 days</name>
   <tag></tag>
   <elementGuidId>905b5882-b788-4054-ac3b-c95c0c4ae0e7</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${stateCode},${countryId}&amp;cnt=45&amp;appid=${appId}</restUrl>
