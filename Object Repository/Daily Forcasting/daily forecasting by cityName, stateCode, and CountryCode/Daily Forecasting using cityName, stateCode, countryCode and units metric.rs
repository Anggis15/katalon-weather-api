...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, stateCode, countryCode and units metric</name>
   <tag></tag>
   <elementGuidId>9b12ea53-6602-4960-9749-1818d2e9202b</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${stateCode},${countryId}&amp;units=metric&amp;appid=${appId}</restUrl>
