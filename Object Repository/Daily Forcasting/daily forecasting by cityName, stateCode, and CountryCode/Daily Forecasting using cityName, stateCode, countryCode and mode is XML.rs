...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, stateCode, countryCode and mode is XML</name>
   <tag></tag>
   <elementGuidId>e13dfdf1-8f0d-415d-9400-6b0776719414</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${stateCode},${countryId}&amp;mode=xml&amp;appid=${appId}</restUrl>
