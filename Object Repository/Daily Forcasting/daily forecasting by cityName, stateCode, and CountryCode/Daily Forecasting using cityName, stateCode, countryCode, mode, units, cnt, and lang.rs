...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, stateCode, countryCode, mode, units, cnt, and lang</name>
   <tag></tag>
   <elementGuidId>11560649-b833-461c-840e-09f39843fa00</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${stateCode},${countryId}&amp;mode=xml&amp;unit=imperial&amp;cnt=${cnt}&amp;lang=KR&amp;appid=${appId}</restUrl>
