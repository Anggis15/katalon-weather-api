...
<WebServiceRequestEntity>
   ...
   <name>Daily Forecasting using cityName, stateCode, countryCode and units imperial</name>
   <tag></tag>
   <elementGuidId>8c695d5a-ecc2-4689-9e90-4765ab16440c</elementGuidId>
   ...
   <restUrl>https://api.openweathermap.org/data/2.5/forecast?q=${cityName},${stateCode},${countryId}&amp;units=imperial&amp;appid=${appId}</restUrl>
