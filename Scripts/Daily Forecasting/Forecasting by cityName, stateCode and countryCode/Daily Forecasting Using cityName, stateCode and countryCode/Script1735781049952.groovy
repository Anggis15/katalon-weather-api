...
response = WS.sendRequest(findTestObject('Daily Forcasting/daily forecasting by cityName, stateCode, and CountryCode/Daily Forcasting using city name, state code, and countryCode'))
