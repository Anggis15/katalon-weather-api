...
response = WS.sendRequest(findTestObject('Daily Forcasting/daily forecasting by cityName, stateCode, and CountryCode/Daily Forecasting using cityName, stateCode, countryId and lang'))
