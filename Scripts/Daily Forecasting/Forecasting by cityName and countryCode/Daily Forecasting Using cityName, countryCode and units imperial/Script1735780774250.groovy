...
response = WS.sendRequest(findTestObject('Daily Forcasting/daily forecasting using cityName and countryCode/Daily Forecasting using cityName, countryCode and units imperial'))
