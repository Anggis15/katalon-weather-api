...
response = WS.sendRequest(findTestObject('Daily Forcasting/daily forecasting by latitude and longitude/Daily Forecasting using latitude, longitude and units metric'))
